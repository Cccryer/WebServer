...
{
    public:
        WebSocketPacket() = default;
        virtual ~WebSocketPacket() = default;
    ...
    public:
        ...
        // virtual int32_t fetch_handshake_ele(const std::string &msg);
    ...
    public:
        const uint32_t get_handshake_length() { return hs_length_; }
    ...
    public:
        ...
        // {
        //     param_[name] = strHelper::valueOf<std::string, T>(v);
        // }
